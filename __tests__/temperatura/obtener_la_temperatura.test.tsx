...
describe('yo como usuario quiero ver la temperatura actual', () => {
  test('Muestra la temperatura actual en grados Celsius', () => {
    const screen = render(<Index />);

    expect(screen.getByTestId('temperatura')).toHaveTextContent('25°C');
  });
});